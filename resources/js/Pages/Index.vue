<template>
    <div class="screen">
        ...
        <div class="play-area">
            <Link href="/" class="link">PLAY GAME</Link>
        </div>
...
.pop-up .pop-body .pop-btn.info {
    ...
    .bottom-sheet .bottom-area {
        width: 90%;
        margin: 0 auto;
        margin-top: 80px;
    }

    .bottom-sheet .bottom-area .title {
        font-family: 'LemonMilkProUltraBold';
        color: #ffffff;
    }

    .bottom-sheet .bottom-area .content {
        color: #ffffff;
        margin-top: 40px;
    }
